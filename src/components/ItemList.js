      ...
      <div className="flex justify-between">
        <div>
            ...
            <p className="text-left">
               ...
               <span className="m-2 py-2 text-sm">₹{req.card.info.price/100}</span>
             </p> 
            
        </div>
          <div className="w=3/12">
            <div className="absolute">
             <button className="border border-black bg-white text-sm ml-12 px-2 py-1 mt-20 rounded-sm text-yellow-500">Add</button>
            </div>
